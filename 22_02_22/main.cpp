...
//    }
    ...
    /*
     * @name Vector - copy constructor
     * @brief - copy dynamic array data from one vector to another
     * @note - doesn't have a return type
     *
     * */
    Vector(const Vector& other)
    {
        ...
        this->array = new int[this->capacity];
        //this->array = other.array // shallow copy
...
int main(int argc, char** argv) {
    ...
    Vector other(*vptr); // calling copy constructor -
    //other = vptr; // shallow copy
    cout << "vector size: " << other.GetSize() << "vector capacity: " << other.GetCapacity() << endl;
